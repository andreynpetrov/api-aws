<template>
  <div>
    <div class="header">
      ...
      <router-link to="/home" class="heading"
        >AWS Amplify Vue Auth Starter</router-link
      >
      <div class="header-menu">
        <router-link to="/home" class="link">Home</router-link>
        <p class="link" v-on:click="signOut" v-if="isAuthenticated">Sign Out</p>
        <router-link class="link" to="/" v-if="!isAuthenticated"
          >Sign In</router-link
        >
        <router-link class="link" to="/profile" v-if="isAuthenticated"
          >Profile</router-link
        >
